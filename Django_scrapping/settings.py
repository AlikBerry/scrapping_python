"""
Django settings for Django_scrapping project.
...
SECRET_KEY = "0ja7#{SECRET_KEY}r7llnlzpu9o%%p=zj%98vn7!41#p0k!7o(s7=phkt(wh8"
...
INSTALLED_APPS = [
    ...
    # 'api.apps.ApiConfig',
    'scrapping_app.apps.ScrappingAppConfig',
]
...
MIDDLEWARE = [
    ...
    'Django_scrapping.middleware.force_default_middleware.force_default_language_middleware',
...
ROOT_URLCONF = 'Django_scrapping.urls'
...
WSGI_APPLICATION = 'Django_scrapping.wsgi.application'
...
if PROD:  # For production docker use
    ...
    #         'NAME': 'scrape_db_name',
    #         'USER': 'scrape_db_user',
    #         'PASSWORD': '69aqhVhkebt3X4G6uLyGk5dMR4VTcL5fYKTPNKKvq6R9',
    #         'HOST': 'localhost',
    #         'PORT': '5432',
    #     }
    # }
